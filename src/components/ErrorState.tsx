...
export function ErrorState({ message, onRetry }: ErrorStateProps) {
  return (
    ...
    >
      <span className="grid h-10 w-10 place-items-center rounded-full bg-red-100 text-red-600 mx-auto">
      ...
      <button
        type="button"
        onClick={onRetry}
        className="focus-ring mt-4 inline-flex items-center gap-2 rounded-lg bg-red-600 px-4 py-2 text-sm font-semibold text-white shadow-card transition hover:bg-red-700"
      >

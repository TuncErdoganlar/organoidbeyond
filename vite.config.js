...
function pubmedProxyPlugin(mode) {
    var _this = this;
    var serverApiKey = function () { var _a; return (_a = loadEnv(mode, process.cwd(), '').PUBMED_API_KEY) === null || _a === void 0 ? void 0 : _a.trim(); };
    var middleware = function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
        var sp, built, ctl, upstream, ct, text, _a;
        var _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    if (!((_b = req.url) === null || _b === void 0 ? void 0 : _b.startsWith('/api/pubmed'))) {
                        next();
                        return [2 /*return*/];
                    }
                    if (req.method !== 'GET') {
                ...
                case 1:
                    _c.trys.push([1, 4, , 5]);
                    sp = new URL(req.url, 'http://localhost').searchParams;
                    built = resolvePubmedUpstreamUrl(sp, { serverApiKey: serverApiKey() });
                    if (!built.ok) {
